...
def get_options(args=None):
    ...
    parser.add_argument('--env_name', '--env', type=str, default='CartPole-v1', choices = ['CartPole-v1', 'InvertedPendulum-v2', 'HalfCheetah-v2', 'Walker2d-v2', 'Hopper-v2', 'InvertedDoublePendulum-v2'],
    ...
    # elif opts.env_name == 'InvertedPendulum-v2':
        ...
        if opts.env_name == 'InvertedDoublePendulum-v2':
            opts.max_trajectories = 6000
